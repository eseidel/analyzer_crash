...
class Pull-requestLinks {
    ...
    factory Pull-requestLinks.fromJson(Map<String, dynamic>
        json) {
        return Pull-requestLinks(
    ...
    static Pull-requestLinks? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Pull-requestLinks.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Pull-requestLinks
