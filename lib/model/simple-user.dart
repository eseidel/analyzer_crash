...
class Simple-user {
    ...
    factory Simple-user.fromJson(Map<String, dynamic>
        json) {
        return Simple-user(
    ...
    static Simple-user? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Simple-user.fromJson(json);
    }
