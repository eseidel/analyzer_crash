...
import 'package:github/model/simple-user.dart';
@immutable
class Pull-requestHead {
    Pull-requestHead(
        { required this.label,required this.ref,required this.repo,required this.sha,required this.user,
         }
    );

    factory Pull-requestHead.fromJson(Map<String, dynamic>
        json) {
        return Pull-requestHead(
    ...
    static Pull-requestHead? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Pull-requestHead.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Pull-requestHead
            && label == other.label
            && ref == other.ref
            && repo == other.repo
            && sha == other.sha
