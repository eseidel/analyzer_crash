...
import 'package:github/model/security-and-analysis_secret_scanning_ai_detection_status.dart';
@immutable
class Dependabot&#x2F;listSelectedReposForOrgSecret200Response {
    Dependabot&#x2F;listSelectedReposForOrgSecret200Response(
        { required this.total_count, this.repositories = const [],
         }
    );

    factory Dependabot&#x2F;listSelectedReposForOrgSecret200Response.fromJson(Map<String, dynamic>
        json) {
        return Dependabot&#x2F;listSelectedReposForOrgSecret200Response(
    ...
    static Dependabot&#x2F;listSelectedReposForOrgSecret200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Dependabot&#x2F;listSelectedReposForOrgSecret200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Dependabot&#x2F;listSelectedReposForOrgSecret200Response
