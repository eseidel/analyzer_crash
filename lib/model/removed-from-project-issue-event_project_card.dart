...
import 'package:github/model/removed-from-project-issue-event_project_card.dart';
@immutable
class Removed-from-project-issue-eventProjectCard {
    Removed-from-project-issue-eventProjectCard(
    ...
    factory Removed-from-project-issue-eventProjectCard.fromJson(Map<String, dynamic>
        json) {
        return Removed-from-project-issue-eventProjectCard(
    ...
    static Removed-from-project-issue-eventProjectCard? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Removed-from-project-issue-eventProjectCard.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Removed-from-project-issue-eventProjectCard
            && id == other.id
            && url == other.url
