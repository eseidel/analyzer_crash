...
import 'package:github/model/security-and-analysis_secret_scanning_ai_detection_status.dart';
@immutable
class Codespaces&#x2F;listSelectedReposForOrgSecret200Response {
    Codespaces&#x2F;listSelectedReposForOrgSecret200Response(
        { required this.total_count, this.repositories = const [],
         }
    );

    factory Codespaces&#x2F;listSelectedReposForOrgSecret200Response.fromJson(Map<String, dynamic>
        json) {
        return Codespaces&#x2F;listSelectedReposForOrgSecret200Response(
    ...
    static Codespaces&#x2F;listSelectedReposForOrgSecret200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Codespaces&#x2F;listSelectedReposForOrgSecret200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Codespaces&#x2F;listSelectedReposForOrgSecret200Response
