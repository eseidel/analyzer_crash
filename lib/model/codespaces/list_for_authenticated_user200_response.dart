...
import 'package:github/model/codespace_runtime_constraints.dart';
@immutable
class Codespaces&#x2F;listForAuthenticatedUser200Response {
    Codespaces&#x2F;listForAuthenticatedUser200Response(
        { required this.total_count, this.codespaces = const [],
         }
    );

    factory Codespaces&#x2F;listForAuthenticatedUser200Response.fromJson(Map<String, dynamic>
        json) {
        return Codespaces&#x2F;listForAuthenticatedUser200Response(
    ...
    static Codespaces&#x2F;listForAuthenticatedUser200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Codespaces&#x2F;listForAuthenticatedUser200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Codespaces&#x2F;listForAuthenticatedUser200Response
