...
import 'package:github/model/codespaces/create_with_pr_for_authenticated_user_request_geo.dart';
@immutable
class Codespaces&#x2F;createWithPrForAuthenticatedUserRequest {
    Codespaces&#x2F;createWithPrForAuthenticatedUserRequest(
        {  this.location, this.geo, this.client_ip, this.machine, this.devcontainer_path, this.multi_repo_permissions_opt_out, this.working_directory, this.idle_timeout_minutes, this.display_name, this.retention_period_minutes,
         }
    );

    factory Codespaces&#x2F;createWithPrForAuthenticatedUserRequest.fromJson(Map<String, dynamic>
        json) {
        return Codespaces&#x2F;createWithPrForAuthenticatedUserRequest(
            location: json['location'] as String? ,
            geo: Codespaces/createWithPrForAuthenticatedUserRequestGeo.maybeFromJson(json['geo'] as String?) ,
    ...
    static Codespaces&#x2F;createWithPrForAuthenticatedUserRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Codespaces&#x2F;createWithPrForAuthenticatedUserRequest.fromJson(json);
    }

    final  String? location;
    final  Codespaces/createWithPrForAuthenticatedUserRequestGeo? geo;
    ...
    bool operator ==(Object other) {
        ...
        return other is Codespaces&#x2F;createWithPrForAuthenticatedUserRequest
