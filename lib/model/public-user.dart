...
class Public-user {
    ...
    factory Public-user.fromJson(Map<String, dynamic>
        ...
        return Public-user(
            ...
            plan: Public-userPlan.maybeFromJson(json['plan'] as Map<String, dynamic>?) ,
    ...
    static Public-user? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Public-user.fromJson(json);
    }
