...
import 'package:github/model/branch-restriction-policy_users_inner.dart';
@immutable
class Branch-restriction-policyUsersInner {
    Branch-restriction-policyUsersInner(
        {  this.login, this.id, this.node_id, this.avatar_url, this.gravatar_id, this.url, this.html_url, this.followers_url, this.following_url, this.gists_url, this.starred_url, this.subscriptions_url, this.organizations_url, this.repos_url, this.events_url, this.received_events_url, this.type, this.site_admin, this.user_view_type,
         }
    );

    factory Branch-restriction-policyUsersInner.fromJson(Map<String, dynamic>
        json) {
        return Branch-restriction-policyUsersInner(
    ...
    static Branch-restriction-policyUsersInner? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Branch-restriction-policyUsersInner.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Branch-restriction-policyUsersInner
            && login == other.login
            && id == other.id
