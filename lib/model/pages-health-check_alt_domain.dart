...
import 'package:github/model/pages-health-check_alt_domain.dart';
@immutable
class Pages-health-checkAltDomain {
    Pages-health-checkAltDomain(
    ...
    factory Pages-health-checkAltDomain.fromJson(Map<String, dynamic>
        json) {
        return Pages-health-checkAltDomain(
    ...
    static Pages-health-checkAltDomain? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Pages-health-checkAltDomain.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Pages-health-checkAltDomain
            && host == other.host
            && uri == other.uri
