...
class Codespace {
    ...
    factory Codespace.fromJson(Map<String, dynamic>
        ...
        return Codespace(
            ...
            git_status: CodespaceGitStatus.fromJson(json['git_status'] as Map<String, dynamic>) ,
            ...
            runtime_constraints: CodespaceRuntimeConstraints.maybeFromJson(json['runtime_constraints'] as Map<String, dynamic>?) ,
            ...
            last_known_stop_notice: json['last_known_stop_notice'] as String? ,
        );
    }
    ...
    final String  url;
    final CodespaceGitStatus  git_status;
    ...
    final  CodespaceRuntimeConstraints? runtime_constraints;
    ...
    final  String? last_known_stop_notice;
    ...
    bool operator ==(Object other) {
        ...
        return other is Codespace
            ...
            && last_known_stop_notice == other.last_known_stop_notice
        ;
    }
}
