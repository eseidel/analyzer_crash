...
import 'package:github/model/security-and-analysis_secret_scanning_ai_detection_status.dart';
@immutable
class Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response {
    Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response(
        { required this.total_count, this.repositories = const [],
         }
    );

    factory Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response.fromJson(Map<String, dynamic>
        json) {
        return Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response(
    ...
    static Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Actions&#x2F;listRepoAccessToSelfHostedRunnerGroupInOrg200Response
