...
import 'package:github/model/actions-secret.dart';
@immutable
class Actions&#x2F;listRepoSecrets200Response {
    Actions&#x2F;listRepoSecrets200Response(
        { required this.total_count, this.secrets = const [],
         }
    );

    factory Actions&#x2F;listRepoSecrets200Response.fromJson(Map<String, dynamic>
        json) {
        return Actions&#x2F;listRepoSecrets200Response(
    ...
    static Actions&#x2F;listRepoSecrets200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Actions&#x2F;listRepoSecrets200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Actions&#x2F;listRepoSecrets200Response
