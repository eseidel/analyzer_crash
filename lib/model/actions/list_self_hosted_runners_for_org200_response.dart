...
import 'package:github/model/runner-label_type.dart';
@immutable
class Actions&#x2F;listSelfHostedRunnersForOrg200Response {
    Actions&#x2F;listSelfHostedRunnersForOrg200Response(
        { required this.total_count, this.runners = const [],
         }
    );

    factory Actions&#x2F;listSelfHostedRunnersForOrg200Response.fromJson(Map<String, dynamic>
        json) {
        return Actions&#x2F;listSelfHostedRunnersForOrg200Response(
    ...
    static Actions&#x2F;listSelfHostedRunnersForOrg200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Actions&#x2F;listSelfHostedRunnersForOrg200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Actions&#x2F;listSelfHostedRunnersForOrg200Response
