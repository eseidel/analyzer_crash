...
import 'package:github/model/demilestoned-issue-event_milestone.dart';
@immutable
class Demilestoned-issue-event {
    Demilestoned-issue-event(
        { required this.id,required this.node_id,required this.url,required this.actor,required this.event,required this.commit_id,required this.commit_url,required this.created_at,required this.performed_via_github_app,required this.milestone,
         }
    );

    factory Demilestoned-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Demilestoned-issue-event(
            ...
            milestone: Demilestoned-issue-eventMilestone.fromJson(json['milestone'] as Map<String, dynamic>) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Demilestoned-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Demilestoned-issue-event.fromJson(json);
    }
    ...
    final Demilestoned-issue-eventMilestone  milestone;
    ...
    bool operator ==(Object other) {
        ...
        return other is Demilestoned-issue-event
            && id == other.id
