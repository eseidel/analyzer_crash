...
class Labeled-issue-event {
    ...
    factory Labeled-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Labeled-issue-event(
            ...
            label: Labeled-issue-eventLabel.fromJson(json['label'] as Map<String, dynamic>) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Labeled-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Labeled-issue-event.fromJson(json);
    }
    ...
    final Labeled-issue-eventLabel  label;
    ...
    bool operator ==(Object other) {
        ...
        return other is Labeled-issue-event
            && id == other.id
