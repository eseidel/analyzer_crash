...
import 'package:github/model/code-security-configuration_enforcement.dart';
@immutable
class Code-security-default-configurationsInner {
    Code-security-default-configurationsInner(
        {  this.default_for_new_repos, this.configuration,
         }
    );

    factory Code-security-default-configurationsInner.fromJson(Map<String, dynamic>
        json) {
        return Code-security-default-configurationsInner(
            default_for_new_repos: Code-security-default-configurationsInnerDefaultForNewRepos.maybeFromJson(json['default_for_new_repos'] as String?) ,
    ...
    static Code-security-default-configurationsInner? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Code-security-default-configurationsInner.fromJson(json);
    }

    final  Code-security-default-configurationsInnerDefaultForNewRepos? default_for_new_repos;
    ...
    bool operator ==(Object other) {
        ...
        return other is Code-security-default-configurationsInner
