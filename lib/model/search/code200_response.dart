...
import 'package:github/model/search-result-text-matches_inner_matches_inner.dart';
@immutable
class Search&#x2F;code200Response {
    Search&#x2F;code200Response(
        { required this.total_count,required this.incomplete_results, this.items = const [],
         }
    );

    factory Search&#x2F;code200Response.fromJson(Map<String, dynamic>
        json) {
        return Search&#x2F;code200Response(
            total_count: (json['total_count'] as int).toInt() ,
            incomplete_results: (json['incomplete_results'] as bool) ,
            items: (json['items'] as List).map<Code-search-result-item>((e) => Code-search-result-item.fromJson(e as Map<String, dynamic>) ).toList() ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Search&#x2F;code200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Search&#x2F;code200Response.fromJson(json);
    }

    final int  total_count;
    final bool  incomplete_results;
    final List<Code-search-result-item>  items;
    ...
    bool operator ==(Object other) {
        ...
        return other is Search&#x2F;code200Response
