...
import 'package:github/model/app-permissions_starring.dart';
@immutable
class Apps&#x2F;scopeTokenRequest {
    Apps&#x2F;scopeTokenRequest(
        { required this.access_token, this.target, this.target_id, this.repositories = const [], this.repository_ids = const [], this.permissions,
         }
    );

    factory Apps&#x2F;scopeTokenRequest.fromJson(Map<String, dynamic>
        json) {
        return Apps&#x2F;scopeTokenRequest(
    ...
    static Apps&#x2F;scopeTokenRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Apps&#x2F;scopeTokenRequest.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Apps&#x2F;scopeTokenRequest
