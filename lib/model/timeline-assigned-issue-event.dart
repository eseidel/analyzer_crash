...
import 'package:github/model/simple-user.dart';
@immutable
class Timeline-assigned-issue-event {
    ...
    factory Timeline-assigned-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Timeline-assigned-issue-event(
    ...
    static Timeline-assigned-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Timeline-assigned-issue-event.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Timeline-assigned-issue-event
            && id == other.id
