...
import 'package:github/model/review-dismissed-issue-event_dismissed_review.dart';
@immutable
class Review-dismissed-issue-event {
    Review-dismissed-issue-event(
        { required this.id,required this.node_id,required this.url,required this.actor,required this.event,required this.commit_id,required this.commit_url,required this.created_at,required this.performed_via_github_app,required this.dismissed_review,
         }
    );

    factory Review-dismissed-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Review-dismissed-issue-event(
            ...
            dismissed_review: Review-dismissed-issue-eventDismissedReview.fromJson(json['dismissed_review'] as Map<String, dynamic>) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Review-dismissed-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Review-dismissed-issue-event.fromJson(json);
    }
    ...
    final Review-dismissed-issue-eventDismissedReview  dismissed_review;
    ...
    bool operator ==(Object other) {
        ...
        return other is Review-dismissed-issue-event
            && id == other.id
