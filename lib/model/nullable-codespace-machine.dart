...
import 'package:github/model/nullable-codespace-machine_prebuild_availability.dart';
@immutable
class Nullable-codespace-machine {
    ...
    factory Nullable-codespace-machine.fromJson(Map<String, dynamic>
        json) {
        return Nullable-codespace-machine(
            ...
            prebuild_availability: Nullable-codespace-machinePrebuildAvailability.fromJson(json['prebuild_availability'] as String) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Nullable-codespace-machine? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Nullable-codespace-machine.fromJson(json);
    }
    ...
    final int  cpus;
    final Nullable-codespace-machinePrebuildAvailability  prebuild_availability;
    ...
    bool operator ==(Object other) {
        ...
        return other is Nullable-codespace-machine
            && name == other.name
