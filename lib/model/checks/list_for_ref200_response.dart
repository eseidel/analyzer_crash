...
import 'package:github/model/nullable-integration_permissions.dart';
@immutable
class Checks&#x2F;listForRef200Response {
    Checks&#x2F;listForRef200Response(
        { required this.total_count, this.check_runs = const [],
         }
    );

    factory Checks&#x2F;listForRef200Response.fromJson(Map<String, dynamic>
        json) {
        return Checks&#x2F;listForRef200Response(
    ...
    static Checks&#x2F;listForRef200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Checks&#x2F;listForRef200Response.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Checks&#x2F;listForRef200Response
