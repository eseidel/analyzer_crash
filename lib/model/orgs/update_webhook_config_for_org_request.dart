...
import 'package:github/model/webhook-config-insecure-ssl.dart';
@immutable
class Orgs&#x2F;updateWebhookConfigForOrgRequest {
    Orgs&#x2F;updateWebhookConfigForOrgRequest(
        {  this.url, this.content_type, this.secret, this.insecure_ssl,
         }
    );

    factory Orgs&#x2F;updateWebhookConfigForOrgRequest.fromJson(Map<String, dynamic>
        json) {
        return Orgs&#x2F;updateWebhookConfigForOrgRequest(
    ...
    static Orgs&#x2F;updateWebhookConfigForOrgRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Orgs&#x2F;updateWebhookConfigForOrgRequest.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Orgs&#x2F;updateWebhookConfigForOrgRequest
            && url == other.url
