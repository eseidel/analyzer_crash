...
class Milestone {
    Milestone(
        { required this.url,required this.html_url,required this.labels_url,required this.id,required this.node_id,required this.number, this.state = MilestoneState.open,required this.title,required this.description,required this.creator,required this.open_issues,required this.closed_issues,required this.created_at,required this.updated_at,required this.closed_at,required this.due_on,
         }
    );

    factory Milestone.fromJson(Map<String, dynamic>
        json) {
        return Milestone(
