...
import 'package:github/model/added-to-project-issue-event_project_card.dart';
@immutable
class Added-to-project-issue-eventProjectCard {
    Added-to-project-issue-eventProjectCard(
    ...
    factory Added-to-project-issue-eventProjectCard.fromJson(Map<String, dynamic>
        json) {
        return Added-to-project-issue-eventProjectCard(
    ...
    static Added-to-project-issue-eventProjectCard? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Added-to-project-issue-eventProjectCard.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Added-to-project-issue-eventProjectCard
            && id == other.id
            && url == other.url
