...
class Issue {
    ...
    factory Issue.fromJson(Map<String, dynamic>
        json) {
        return Issue(
            ...
            state_reason: IssueStateReason.maybeFromJson(json['state_reason'] as String?) ,
            title: json['title'] as String ,
            body: json['body'] as String? ,
            user: Nullable-simple-user.fromJson(json['user'] as Map<String, dynamic>) ,
            labels: (json['labels'] as List).map<IssueLabelsInner>((e) => IssueLabelsInner.fromJson(e as dynamic)).toList() ,
            ...
            pull_request: IssuePullRequest.maybeFromJson(json['pull_request'] as Map<String, dynamic>?) ,
    ...
    final int  number;
    final String  state;
    final  IssueStateReason? state_reason;
    final String  title;
    final  String? body;
    ...
    final int  comments;
    final  IssuePullRequest? pull_request;
