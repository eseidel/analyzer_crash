...
import 'package:github/model/nullable-organization-simple.dart';
@immutable
class Nullable-organization-simple {
    ...
    factory Nullable-organization-simple.fromJson(Map<String, dynamic>
        json) {
        return Nullable-organization-simple(
    ...
    static Nullable-organization-simple? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Nullable-organization-simple.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Nullable-organization-simple
            && login == other.login
            && id == other.id
