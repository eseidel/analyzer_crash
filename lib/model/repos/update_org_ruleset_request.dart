...
import 'package:github/model/repository-rule-params-code-scanning-tool_security_alerts_threshold.dart';
@immutable
class Repos&#x2F;updateOrgRulesetRequest {
    Repos&#x2F;updateOrgRulesetRequest(
        {  this.name, this.target, this.enforcement, this.bypass_actors = const [], this.conditions, this.rules = const [],
         }
    );

    factory Repos&#x2F;updateOrgRulesetRequest.fromJson(Map<String, dynamic>
        json) {
        return Repos&#x2F;updateOrgRulesetRequest(
            name: json['name'] as String? ,
            target: Repos/updateOrgRulesetRequestTarget.maybeFromJson(json['target'] as String?) ,
            enforcement: Repository-rule-enforcement.maybeFromJson(json['enforcement'] as String?) ,
            ...
            conditions: Org-ruleset-conditions.maybeFromJson(json['conditions'] as dynamic),
    ...
    static Repos&#x2F;updateOrgRulesetRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Repos&#x2F;updateOrgRulesetRequest.fromJson(json);
    }

    final  String? name;
    final  Repos/updateOrgRulesetRequestTarget? target;
    final  Repository-rule-enforcement? enforcement;
    final  List<Repository-ruleset-bypass-actor>? bypass_actors;
    final  Org-ruleset-conditions? conditions;
    ...
    bool operator ==(Object other) {
        ...
        return other is Repos&#x2F;updateOrgRulesetRequest
            && name == other.name
            && target == other.target
