...
import 'package:github/model/repository-rule-params-code-scanning-tool_security_alerts_threshold.dart';
@immutable
class Repos&#x2F;createOrgRulesetRequest {
    Repos&#x2F;createOrgRulesetRequest(
        { required this.name, this.target = Repos/createOrgRulesetRequestTarget.branch,required this.enforcement, this.bypass_actors = const [], this.conditions, this.rules = const [],
         }
    );

    factory Repos&#x2F;createOrgRulesetRequest.fromJson(Map<String, dynamic>
        json) {
        return Repos&#x2F;createOrgRulesetRequest(
            name: json['name'] as String ,
            target: Repos/createOrgRulesetRequestTarget.maybeFromJson(json['target'] as String?) ,
    ...
    static Repos&#x2F;createOrgRulesetRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Repos&#x2F;createOrgRulesetRequest.fromJson(json);
    }

    final String  name;
    final  Repos/createOrgRulesetRequestTarget? target;
    ...
    bool operator ==(Object other) {
        ...
        return other is Repos&#x2F;createOrgRulesetRequest
            && name == other.name
            && target == other.target
