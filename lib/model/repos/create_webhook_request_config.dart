...
import 'package:github/model/webhook-config-insecure-ssl.dart';
@immutable
class Repos&#x2F;createWebhookRequestConfig {
    Repos&#x2F;createWebhookRequestConfig(
        {  this.url, this.content_type, this.secret, this.insecure_ssl,
         }
    );

    factory Repos&#x2F;createWebhookRequestConfig.fromJson(Map<String, dynamic>
        json) {
        return Repos&#x2F;createWebhookRequestConfig(
    ...
    static Repos&#x2F;createWebhookRequestConfig? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Repos&#x2F;createWebhookRequestConfig.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Repos&#x2F;createWebhookRequestConfig
            && url == other.url
