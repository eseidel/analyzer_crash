...
import 'package:github/model/repository-rule-params-code-scanning-tool_security_alerts_threshold.dart';
@immutable
class Repos&#x2F;updateRepoRulesetRequest {
    Repos&#x2F;updateRepoRulesetRequest(
        {  this.name, this.target, this.enforcement, this.bypass_actors = const [], this.conditions, this.rules = const [],
         }
    );

    factory Repos&#x2F;updateRepoRulesetRequest.fromJson(Map<String, dynamic>
        json) {
        return Repos&#x2F;updateRepoRulesetRequest(
            name: json['name'] as String? ,
            target: Repos/updateRepoRulesetRequestTarget.maybeFromJson(json['target'] as String?) ,
    ...
    static Repos&#x2F;updateRepoRulesetRequest? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Repos&#x2F;updateRepoRulesetRequest.fromJson(json);
    }

    final  String? name;
    final  Repos/updateRepoRulesetRequestTarget? target;
    ...
    bool operator ==(Object other) {
        ...
        return other is Repos&#x2F;updateRepoRulesetRequest
            && name == other.name
            && target == other.target
