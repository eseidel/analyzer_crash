...
class Gist-simpleForkOf {
    ...
    factory Gist-simpleForkOf.fromJson(Map<String, dynamic>
        json) {
        return Gist-simpleForkOf(
            ...
            files: json['files'].map((key, value) => MapEntry(key, Gist-simpleForkOfFiles.fromJson(value as Map<String, dynamic>) )).toMap(),
    ...
    static Gist-simpleForkOf? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Gist-simpleForkOf.fromJson(json);
    }
    ...
    final Map<String, Gist-simpleForkOfFiles>  files;
    final bool  public;
    ...
    bool operator ==(Object other) {
        ...
        return other is Gist-simpleForkOf
            && url == other.url
