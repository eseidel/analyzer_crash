...
class ActionsRunnerLabelsResponse {
    ...
    factory ActionsRunnerLabelsResponse.fromJson(Map<String, dynamic>
        json) {
        return ActionsRunnerLabelsResponse(
    ...
    static ActionsRunnerLabelsResponse? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
