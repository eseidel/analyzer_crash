...
class Nullable-team-simple {
    ...
    factory Nullable-team-simple.fromJson(Map<String, dynamic>
        json) {
        return Nullable-team-simple(
    ...
    static Nullable-team-simple? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Nullable-team-simple.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Nullable-team-simple
            && id == other.id
