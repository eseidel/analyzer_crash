...
class Team-repository {
    ...
    factory Team-repository.fromJson(Map<String, dynamic>
        ...
        return Team-repository(
            ...
            permissions: Team-repositoryPermissions.maybeFromJson(json['permissions'] as Map<String, dynamic>?) ,
    ...
    static Team-repository? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Team-repository.fromJson(json);
    }
    ...
    final int  forks;
    final  Team-repositoryPermissions? permissions;
    ...
    bool operator ==(Object other) {
        ...
        return other is Team-repository
            && id == other.id
