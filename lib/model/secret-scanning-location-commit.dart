...
import 'package:github/model/secret-scanning-location-commit.dart';
@immutable
class Secret-scanning-location-commit {
    Secret-scanning-location-commit(
        { required this.path,required this.start_line,required this.end_line,required this.start_column,required this.end_column,required this.blob_sha,required this.blob_url,required this.commit_sha,required this.commit_url,
         }
    );

    factory Secret-scanning-location-commit.fromJson(Map<String, dynamic>
        json) {
        return Secret-scanning-location-commit(
    ...
    static Secret-scanning-location-commit? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Secret-scanning-location-commit.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Secret-scanning-location-commit
            && path == other.path
