...
class Milestoned-issue-event {
    ...
    factory Milestoned-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Milestoned-issue-event(
            ...
            milestone: Milestoned-issue-eventMilestone.fromJson(json['milestone'] as Map<String, dynamic>) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Milestoned-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Milestoned-issue-event.fromJson(json);
    }
    ...
    final Milestoned-issue-eventMilestone  milestone;
    ...
    bool operator ==(Object other) {
        ...
        return other is Milestoned-issue-event
            && id == other.id
