...
class Repository {
    ...
    factory Repository.fromJson(Map<String, dynamic>
        json) {
        return Repository(
            ...
            permissions: RepositoryPermissions.maybeFromJson(json['permissions'] as Map<String, dynamic>?) ,
            ...
            squash_merge_commit_title: RepositorySquashMergeCommitTitle.maybeFromJson(json['squash_merge_commit_title'] as String?) ,
            squash_merge_commit_message: RepositorySquashMergeCommitMessage.maybeFromJson(json['squash_merge_commit_message'] as String?) ,
            merge_commit_title: RepositoryMergeCommitTitle.maybeFromJson(json['merge_commit_title'] as String?) ,
            merge_commit_message: RepositoryMergeCommitMessage.maybeFromJson(json['merge_commit_message'] as String?) ,
            ...
            code_search_index_status: RepositoryCodeSearchIndexStatus.maybeFromJson(json['code_search_index_status'] as Map<String, dynamic>?) ,
        );
    }
    ...
    final  RepositorySquashMergeCommitTitle? squash_merge_commit_title;
    final  RepositorySquashMergeCommitMessage? squash_merge_commit_message;
    final  RepositoryMergeCommitTitle? merge_commit_title;
    final  RepositoryMergeCommitMessage? merge_commit_message;
    ...
    final  RepositoryCodeSearchIndexStatus? code_search_index_status;
