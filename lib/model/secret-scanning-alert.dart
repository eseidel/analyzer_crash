...
import 'package:github/model/secret-scanning-location-pull-request-review-comment.dart';
@immutable
class Secret-scanning-alert {
    Secret-scanning-alert(
        {  this.number, this.created_at, this.updated_at, this.url, this.html_url, this.locations_url, this.state, this.resolution, this.resolved_at, this.resolved_by, this.resolution_comment, this.secret_type, this.secret_type_display_name, this.secret, this.push_protection_bypassed, this.push_protection_bypassed_by, this.push_protection_bypassed_at, this.push_protection_bypass_request_reviewer, this.push_protection_bypass_request_reviewer_comment, this.push_protection_bypass_request_comment, this.push_protection_bypass_request_html_url, this.validity, this.publicly_leaked, this.multi_repo, this.is_base64_encoded, this.first_location_detected, this.has_more_locations,
         }
    );

    factory Secret-scanning-alert.fromJson(Map<String, dynamic>
        json) {
        return Secret-scanning-alert(
            ...
            validity: Secret-scanning-alertValidity.maybeFromJson(json['validity'] as String?) ,
    ...
    static Secret-scanning-alert? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Secret-scanning-alert.fromJson(json);
    }
    ...
    final  Secret-scanning-alertValidity? validity;
    ...
    bool operator ==(Object other) {
        ...
        return other is Secret-scanning-alert
            && number == other.number
