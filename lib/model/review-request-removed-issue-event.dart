...
import 'package:github/model/simple-user.dart';
@immutable
class Review-request-removed-issue-event {
    Review-request-removed-issue-event(
        { required this.id,required this.node_id,required this.url,required this.actor,required this.event,required this.commit_id,required this.commit_url,required this.created_at,required this.performed_via_github_app,required this.review_requester, this.requested_team, this.requested_reviewer,
         }
    );

    factory Review-request-removed-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Review-request-removed-issue-event(
            ...
            review_requester: Simple-user.fromJson(json['review_requester'] as Map<String, dynamic>) ,
            requested_team: Team.maybeFromJson(json['requested_team'] as Map<String, dynamic>?) ,
            requested_reviewer: Simple-user.maybeFromJson(json['requested_reviewer'] as Map<String, dynamic>?) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Review-request-removed-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Review-request-removed-issue-event.fromJson(json);
    }
    ...
    final Simple-user  review_requester;
    final  Team? requested_team;
    final  Simple-user? requested_reviewer;
    ...
    bool operator ==(Object other) {
        ...
        return other is Review-request-removed-issue-event
            && id == other.id
