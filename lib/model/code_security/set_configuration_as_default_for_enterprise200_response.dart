...
import 'package:github/model/code-security-configuration_enforcement.dart';
@immutable
class CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response {
    CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response(
        {  this.default_for_new_repos, this.configuration,
         }
    );

    factory CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response.fromJson(Map<String, dynamic>
        json) {
        return CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response(
            default_for_new_repos: CodeSecurity/setConfigurationAsDefaultForEnterprise200ResponseDefaultForNewRepos.maybeFromJson(json['default_for_new_repos'] as String?) ,
    ...
    static CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response.fromJson(json);
    }

    final  CodeSecurity/setConfigurationAsDefaultForEnterprise200ResponseDefaultForNewRepos? default_for_new_repos;
    ...
    bool operator ==(Object other) {
        ...
        return other is CodeSecurity&#x2F;setConfigurationAsDefaultForEnterprise200Response
