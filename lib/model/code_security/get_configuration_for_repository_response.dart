...
sealed class CodeSecurity&#x2F;getConfigurationForRepositoryResponse {
    static CodeSecurity&#x2F;getConfigurationForRepositoryResponse fromJson(dynamic jsonArg) {
        // Determine which schema to use based on the json.
        // TODO(eseidel): Implement this.
        throw UnimplementedError('CodeSecurity&#x2F;getConfigurationForRepositoryResponse.fromJson');
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static CodeSecurity&#x2F;getConfigurationForRepositoryResponse? maybeFromJson(dynamic json) {
        if (json == null) {
            return null;
        }
        return CodeSecurity&#x2F;getConfigurationForRepositoryResponse.fromJson(json);
    }
