...
import 'package:github/model/simple-user.dart';
@immutable
class Pull-requestBase {
    Pull-requestBase(
        { required this.label,required this.ref,required this.repo,required this.sha,required this.user,
         }
    );

    factory Pull-requestBase.fromJson(Map<String, dynamic>
        json) {
        return Pull-requestBase(
    ...
    static Pull-requestBase? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Pull-requestBase.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Pull-requestBase
            && label == other.label
            && ref == other.ref
            && repo == other.repo
            && sha == other.sha
