...
import 'package:github/model/added-to-project-issue-event_project_card.dart';
@immutable
class Added-to-project-issue-event {
    ...
    factory Added-to-project-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Added-to-project-issue-event(
            ...
            project_card: Added-to-project-issue-eventProjectCard.maybeFromJson(json['project_card'] as Map<String, dynamic>?) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Added-to-project-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Added-to-project-issue-event.fromJson(json);
    }
    ...
    final  Added-to-project-issue-eventProjectCard? project_card;
    ...
    bool operator ==(Object other) {
        ...
        return other is Added-to-project-issue-event
            && id == other.id
