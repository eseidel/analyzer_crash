...
import 'package:github/model/moved-column-in-project-issue-event_project_card.dart';
@immutable
class Moved-column-in-project-issue-event {
    ...
    factory Moved-column-in-project-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Moved-column-in-project-issue-event(
            ...
            project_card: Moved-column-in-project-issue-eventProjectCard.maybeFromJson(json['project_card'] as Map<String, dynamic>?) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Moved-column-in-project-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Moved-column-in-project-issue-event.fromJson(json);
    }
    ...
    final  Moved-column-in-project-issue-eventProjectCard? project_card;
    ...
    bool operator ==(Object other) {
        ...
        return other is Moved-column-in-project-issue-event
            && id == other.id
