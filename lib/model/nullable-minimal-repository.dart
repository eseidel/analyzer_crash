...
import 'package:github/model/security-and-analysis_secret_scanning_ai_detection_status.dart';
@immutable
class Nullable-minimal-repository {
    Nullable-minimal-repository(
        { required this.id,required this.node_id,required this.name,required this.full_name,required this.owner,required this.private,required this.html_url,required this.description,required this.fork,required this.url,required this.archive_url,required this.assignees_url,required this.blobs_url,required this.branches_url,required this.collaborators_url,required this.comments_url,required this.commits_url,required this.compare_url,required this.contents_url,required this.contributors_url,required this.deployments_url,required this.downloads_url,required this.events_url,required this.forks_url,required this.git_commits_url,required this.git_refs_url,required this.git_tags_url, this.git_url,required this.issue_comment_url,required this.issue_events_url,required this.issues_url,required this.keys_url,required this.labels_url,required this.languages_url,required this.merges_url,required this.milestones_url,required this.notifications_url,required this.pulls_url,required this.releases_url, this.ssh_url,required this.stargazers_url,required this.statuses_url,required this.subscribers_url,required this.subscription_url,required this.tags_url,required this.teams_url,required this.trees_url, this.clone_url, this.mirror_url,required this.hooks_url, this.svn_url, this.homepage, this.language, this.forks_count, this.stargazers_count, this.watchers_count, this.size, this.default_branch, this.open_issues_count, this.is_template, this.topics = const [], this.has_issues, this.has_projects, this.has_wiki, this.has_pages, this.has_downloads, this.has_discussions, this.archived, this.disabled, this.visibility, this.pushed_at, this.created_at, this.updated_at, this.permissions, this.role_name, this.temp_clone_token, this.delete_branch_on_merge, this.subscribers_count, this.network_count, this.code_of_conduct, this.license, this.forks, this.open_issues, this.watchers, this.allow_forking, this.web_commit_signoff_required, this.security_and_analysis, this.custom_properties,
         }
    );

    factory Nullable-minimal-repository.fromJson(Map<String, dynamic>
        json) {
        return Nullable-minimal-repository(
            ...
            permissions: Nullable-minimal-repositoryPermissions.maybeFromJson(json['permissions'] as Map<String, dynamic>?) ,
            ...
            code_of_conduct: Code-of-conduct.maybeFromJson(json['code_of_conduct'] as Map<String, dynamic>?) ,
            license: Nullable-minimal-repositoryLicense.maybeFromJson(json['license'] as Map<String, dynamic>?) ,
    ...
    static Nullable-minimal-repository? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Nullable-minimal-repository.fromJson(json);
    }
    ...
    final  Nullable-minimal-repositoryPermissions? permissions;
    final  String? role_name;
    final  String? temp_clone_token;
    final  bool? delete_branch_on_merge;
    final  int? subscribers_count;
    final  int? network_count;
    final  Code-of-conduct? code_of_conduct;
    final  Nullable-minimal-repositoryLicense? license;
    final  int? forks;
    ...
    bool operator ==(Object other) {
        ...
        return other is Nullable-minimal-repository
            && id == other.id
