...
class Webhook-config {
    ...
    factory Webhook-config.fromJson(Map<String, dynamic>
        json) {
    ...
    static Webhook-config? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Webhook-config.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Webhook-config
            && url == other.url
