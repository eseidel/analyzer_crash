...
class Minimal-repository {
    ...
    factory Minimal-repository.fromJson(Map<String, dynamic>
        json) {
        return Minimal-repository(
            ...
            permissions: Minimal-repositoryPermissions.maybeFromJson(json['permissions'] as Map<String, dynamic>?) ,
            ...
            license: Minimal-repositoryLicense.maybeFromJson(json['license'] as Map<String, dynamic>?) ,
    ...
    static Minimal-repository? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Minimal-repository.fromJson(json);
    }
    ...
    final  Minimal-repositoryPermissions? permissions;
    ...
    final  Minimal-repositoryLicense? license;
    final  int? forks;
    ...
    bool operator ==(Object other) {
        ...
        return other is Minimal-repository
            && id == other.id
