...
import 'package:github/model/simple-user.dart';
@immutable
class Nullable-simple-repository {
    ...
    factory Nullable-simple-repository.fromJson(Map<String, dynamic>
        json) {
        return Nullable-simple-repository(
    ...
    static Nullable-simple-repository? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Nullable-simple-repository.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Nullable-simple-repository
            && id == other.id
