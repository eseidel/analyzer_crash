...
import 'package:github/model/nullable-simple-user.dart';
@immutable
class Code-scanning-alert-items {
    ...
    factory Code-scanning-alert-items.fromJson(Map<String, dynamic>
        json) {
        return Code-scanning-alert-items(
    ...
    static Code-scanning-alert-items? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Code-scanning-alert-items.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Code-scanning-alert-items
            && number == other.number
