...
class Issue-comment {
    Issue-comment(
        { required this.id,required this.node_id,required this.url, this.body, this.body_text, this.body_html,required this.html_url,required this.user,required this.created_at,required this.updated_at,required this.issue_url,required this.author_association, this.performed_via_github_app, this.reactions,
         }
    );

    factory Issue-comment.fromJson(Map<String, dynamic>
        json) {
    ...
    static Issue-comment? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Issue-comment.fromJson(json);
    }
