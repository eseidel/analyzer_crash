...
import 'package:github/model/nullable-simple-user.dart';
@immutable
class Code-scanning-organization-alert-items {
    Code-scanning-organization-alert-items(
        { required this.number,required this.created_at, this.updated_at,required this.url,required this.html_url,required this.instances_url,required this.state, this.fixed_at,required this.dismissed_by,required this.dismissed_at,required this.dismissed_reason, this.dismissed_comment,required this.rule,required this.tool,required this.most_recent_instance,required this.repository, this.dismissal_approved_by,
         }
    );

    factory Code-scanning-organization-alert-items.fromJson(Map<String, dynamic>
        json) {
        return Code-scanning-organization-alert-items(
            ...
            rule: Code-scanning-alert-rule-summary.fromJson(json['rule'] as Map<String, dynamic>) ,
    ...
    static Code-scanning-organization-alert-items? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Code-scanning-organization-alert-items.fromJson(json);
    }
    ...
    final Code-scanning-alert-rule-summary  rule;
    ...
    bool operator ==(Object other) {
        ...
        return other is Code-scanning-organization-alert-items
            && number == other.number
