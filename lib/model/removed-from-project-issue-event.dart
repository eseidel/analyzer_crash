...
import 'package:github/model/removed-from-project-issue-event_project_card.dart';
@immutable
class Removed-from-project-issue-event {
    ...
    factory Removed-from-project-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Removed-from-project-issue-event(
            ...
            project_card: Removed-from-project-issue-eventProjectCard.maybeFromJson(json['project_card'] as Map<String, dynamic>?) ,
        );
    }

    /// Convenience to create a nullable type from a nullable json object.
    /// Useful when parsing optional fields.
    static Removed-from-project-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Removed-from-project-issue-event.fromJson(json);
    }
    ...
    final  Removed-from-project-issue-eventProjectCard? project_card;
    ...
    bool operator ==(Object other) {
        ...
        return other is Removed-from-project-issue-event
            && id == other.id
