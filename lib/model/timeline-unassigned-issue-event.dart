...
import 'package:github/model/simple-user.dart';
@immutable
class Timeline-unassigned-issue-event {
    Timeline-unassigned-issue-event(
        { required this.id,required this.node_id,required this.url,required this.actor,required this.event,required this.commit_id,required this.commit_url,required this.created_at,required this.performed_via_github_app,required this.assignee,
         }
    );

    factory Timeline-unassigned-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Timeline-unassigned-issue-event(
    ...
    static Timeline-unassigned-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Timeline-unassigned-issue-event.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Timeline-unassigned-issue-event
            && id == other.id
