...
class User-role-assignment {
    ...
    static User-role-assignment? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return User-role-assignment.fromJson(json);
    }

    final  User-role-assignmentAssignment? assignment;
    final  List<Team-simple>? inherited_from;
    final  String? name;
    final  String? email;
    final String  login;
    final int  id;
    ...
    Map<String, dynamic> toJson() {
        return {
            ...
            'inherited_from': inherited_from?.map((e) => e.toJson()).toList(),
            'name': name,
            'email': email,
            'login': login,
            'id': id,
    ...
    bool operator ==(Object other) {
        ...
        return other is User-role-assignment
            && assignment == other.assignment
            && listsEqual(inherited_from, other.inherited_from)
            && name == other.name
            && email == other.email
            && login == other.login
            && id == other.id
