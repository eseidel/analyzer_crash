...
import 'package:github/model/nullable-integration_permissions.dart';
@immutable
class State-change-issue-event {
    State-change-issue-event(
        { required this.id,required this.node_id,required this.url,required this.actor,required this.event,required this.commit_id,required this.commit_url,required this.created_at,required this.performed_via_github_app, this.state_reason,
         }
    );

    factory State-change-issue-event.fromJson(Map<String, dynamic>
        json) {
        return State-change-issue-event(
    ...
    static State-change-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return State-change-issue-event.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is State-change-issue-event
            && id == other.id
