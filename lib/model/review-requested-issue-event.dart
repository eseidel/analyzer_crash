...
import 'package:github/model/simple-user.dart';
@immutable
class Review-requested-issue-event {
    ...
    factory Review-requested-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Review-requested-issue-event(
    ...
    static Review-requested-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Review-requested-issue-event.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Review-requested-issue-event
            && id == other.id
