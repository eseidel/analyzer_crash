...
import 'package:github/model/nullable-simple-user.dart';
@immutable
class Pull-request-simpleBase {
    Pull-request-simpleBase(
        { required this.label,required this.ref,required this.repo,required this.sha,required this.user,
         }
    );

    factory Pull-request-simpleBase.fromJson(Map<String, dynamic>
        json) {
        return Pull-request-simpleBase(
    ...
    static Pull-request-simpleBase? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Pull-request-simpleBase.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Pull-request-simpleBase
            && label == other.label
            && ref == other.ref
            && repo == other.repo
            && sha == other.sha
