...
class Assigned-issue-event {
    ...
    factory Assigned-issue-event.fromJson(Map<String, dynamic>
        json) {
        return Assigned-issue-event(
    ...
    static Assigned-issue-event? maybeFromJson(Map<String, dynamic>? json) {
        if (json == null) {
            return null;
        }
        return Assigned-issue-event.fromJson(json);
    }
    ...
    bool operator ==(Object other) {
        ...
        return other is Assigned-issue-event
            && id == other.id
